...
class HeartBeatServer:
    ...
    def TimeoutCheck(self, p):
        while True:
            MachineList=DB.Machine.objects.filter(Status=1, LastUpdateTime__lte=int(time.time()) - self.HeartBeatSpeed * 1.5)
        ...
        while True:
            ...
            if data[0] == 0:
                ...
                try:
                    ...
                    continue
                NowMachine.Version = Version
                NowMachine.TotalMemory = TotalMemory
                NowMachine.Cores = Cores
                NowMachine.MotherBoardName = MotherBoard
                NowMachine.SystemName = SystemName
                NowMachine.CPUName = CPUName
                NowMachine.Status = 1
